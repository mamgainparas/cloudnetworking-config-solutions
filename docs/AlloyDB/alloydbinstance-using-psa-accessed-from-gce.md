...
1. Click on Open in Google Cloud Shell button below.
    ...
    <a href="https://ssh.cloud.google.com/cloudshell/editor?shellonly=true&cloudshell_git_repo=https://github.com/GoogleCloudPlatform/cloudnetworking-config-solutions.git&cloudshell_workspace=alloydb-psa&cloudshell_open_in_editor=configuration/organization.tfvars&cloudshell_tutorial=tutorial.md" target="_new">
